...
class Practica4(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica4_leo_leandro", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Practica4_leo_leandro")
        ...
        self.tab.addTab(self.tab_widget_0, 'frecuency')
        self.tab_widget_1 = Qt.QWidget()
        self.tab_layout_1 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_1)
        self.tab_grid_layout_1 = Qt.QGridLayout()
        self.tab_layout_1.addLayout(self.tab_grid_layout_1)
        self.tab.addTab(self.tab_widget_1, 'constelacion')
        self.tab_widget_2 = Qt.QWidget()
        self.tab_layout_2 = Qt.QBoxLayout(Qt.QBoxLayout.TopToBottom, self.tab_widget_2)
        self.tab_grid_layout_2 = Qt.QGridLayout()
        self.tab_layout_2.addLayout(self.tab_grid_layout_2)
        self.tab.addTab(self.tab_widget_2, 'sink')
        ...
        labels = ['adsfdsaf', 'asdfadsfasfdsadfa', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        labels = ['EC-Re', 'EC-lm', 'Signal 3', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [3, 3, 1, 1, 1,
            1, 1, 1, 1, 1]
        colors = ['blue', 'red', 'green', 'black', 'cyan',
        ...
        self.tab_layout_2.addWidget(self._qtgui_time_sink_x_0_0_0_0_win)
        ...
        self.blocks_repack_bits_bb_0 = blocks.repack_bits_bb(1, int(nbps), "", False, gr.GR_LSB_FIRST)
    ...
    def set_m(self, m):
        self.m = m
        self.set_nbps(math.log(self.m,2))
    ...
    def set_nbps(self, nbps):
        self.nbps = nbps
        self.set_rs(self.rb/self.nbps)
        self.blocks_repack_bits_bb_0.set_k_and_l(1,int(self.nbps))
