...
class Practica_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f((1,1,1,1,-1,-1,-1,-1), True, 1, [])
        ...
        self.analog_fastnoise_source_x_0 = analog.fastnoise_source_f(analog.GR_GAUSSIAN, 0, 0, 8192)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.epy_block_0, 0))
        self.connect((self.blocks_throttle2_1, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_vector_source_x_0_0, 0), (self.blocks_add_xx_1, 1))
